 ...
 */
package com.mt.resposity.impl;

import com.mt.hibernatedemo.HiberateUtils;
import com.mt.pojo.Product;
...
public class ProductReponsitoryImpl{
    ...
    public List<Product> getProducts(Map<String, String> params) {
        try (Session session = HiberateUtils.getFactory().openSession()) {
